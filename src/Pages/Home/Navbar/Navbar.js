  ...
  const menuItems = (
    <>
      <li className="">
        <a
          href="/"
          className="text-base font-medium hover:bg-red-500 text-red-500 hover:text-white"
        >
          Home Home
        </a>
      </li>
      <li>
        <a
          href="/"
          className="text-base font-medium hover:bg-red-100 text-red-500 hover:text-orange-500"
        >
          Menu
        </a>
      </li>
      <li>
        <a
          href="/"
          className="text-base font-medium hover:bg-red-100 text-red-500 hover:text-white"
        >
          About
        </a>
      </li>
      ...
      <div class="navbar bg-base-100">
        <div class="navbar-start">
          ...
          <a
            ...
            href="/"
          >
            <h1 id="navStyle" className="font-bold hover:text-red-500">
              COOKING BIRD
            </h1>
            <img
