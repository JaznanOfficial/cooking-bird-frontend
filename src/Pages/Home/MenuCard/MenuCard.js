...
const MenuCard = () => {
    return (
        <div className="flex flex-wrap justify-center items-center">
            <div className="card w-96 hover:bg-red-500 hover:text-neutral-content m-1 border-solid border-2 border-red-500">
            ...
            <div className="card w-96 hover:bg-red-500 hover:text-neutral-content m-1 border-solid border-2 border-red-500 hover:border-none">
                <div className="card-body items-center text-center">
