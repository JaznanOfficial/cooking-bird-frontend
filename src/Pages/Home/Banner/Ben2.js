  ...
  return (
    <div>
      <div id="default-carousel" class="relative" data-carousel="static">
        {/* <!-- Carousel wrapper --> */}
        <div class="relative w-80 h-80 overflow-hidden rounded-lg md:h-96">
          {/* <!-- Item 1 --> */}
          <div
          ...
          >
            <img
              src="https://www.spiceupthecurry.com/wp-content/uploads/2015/12/homemade-yogurt-recipe-7.jpg"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div>
